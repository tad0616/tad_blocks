...
<div class="alert alert-info my-4">
    <{$smarty.const._DOWNLOAD_HEIGHT}><{$smarty.const._TAD_FOR}><input type="number" name="TDC[desc_height]" id="desc_height" value="<{$desc_height|default:''}>" placeholder="<{$smarty.const._DOWNLOAD_HEIGHT}>" style="width: 80px;">
    <br>
    <{$smarty.const._DOWNLOAD_MODE}><{$smarty.const._TAD_FOR}><select name="TDC[mode]]" id="mode" class="my-input">
