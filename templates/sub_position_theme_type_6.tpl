<table id="block-position" style="background: <{$base_color|default:''}>; color:<{$font_color|default:''}>;">
    <tr>
        <td rowspan=4 style="width: <{$lw|default:''}>%; background: <{$lb_color|default:''}>;">
            <!-- 左 -->
            <{include file="$xoops_rootpath/modules/tad_blocks/templates/radio_side_0.tpl"}>
        </td>
        <td rowspan=4 style="width: <{$rw|default:''}>%; background: <{$rb_color|default:''}>;">
            <!-- 右 -->
    ...
    <tr>
        ...
        <td colspan=2 style="background: <{$footer_bgcolor|default:''}>; color: <{$footer_color|default:''}>;">
            <!-- 頁尾中 -->
